...
The API will be accessible at http://localhost:4000.🖥️ Frontend Setup (UI)The frontend is a Next.js application responsible for the user interface.1. Environment ConfigurationCreate a file named .env.local in the ./ui directory:Bash# .env.local (in ui folder)
